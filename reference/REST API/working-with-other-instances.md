---
title: Working with the Australian, Canadian or European Instances
excerpt: ''
deprecated: false
hidden: false
metadata:
...
If your organization is on the Australian, Canadian or European instance, you will need to change the base URL from `https://api.fulcrumapp.com/api/v2/` to one of the following options:
