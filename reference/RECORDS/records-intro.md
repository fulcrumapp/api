...
_Note_: These headers only work with the records API. Batch API calls will always use the configurations as set in the webhooks and workflows interface.
...
| version                     | number  | no       | yes      | Auto-incremented version of the record for history tracking                                                                                                                                                                                        |
...
| changeset_id                | string  | no       | no       | The id of the [changeset](changesets/) associated with the record                                                                                                                                                                                  |
...
| created_latitude            | number  | no       | yes      | The location latitude of where the record was created                                                                                                                                                                                              |
| created_longitude           | number  | no       | yes      | The location longitude of where the record was created                                                                                                                                                                                             |
| created_altitude            | number  | no       | yes      | The location altitude of where the record was created from, in meters above/below (+/-) sea level                                                                                                                                                  |
| created_horizontal_accuracy | number  | no       | yes      | Accuracy of the created latitude and longitude in meters                                                                                                                                                                                           |
| updated_latitude            | number  | no       | yes      | The location latitude of where the record was last updated                                                                                                                                                                                         |
| updated_longitude           | number  | no       | yes      | The location longitude of where the record was last updated                                                                                                                                                                                        |
| updated_altitude            | number  | no       | yes      | The location altitude of where the record was updated, in meters above/below (+/-) sea level                                                                                                                                                       |
| updated_horizontal_accuracy | number  | no       | yes      | Accuracy of the updated latitude and longitude in meters                                                                                                                                                                                           |
| altitude                    | number  | no       | yes      | Meters above/below (+/-) sea level, populated **only** when location has **not** been set manually                                                                                                                                                 |
| speed                       | number  | no       | yes      | Meters per second, populated **only** when location has **not** been set manually.                                                                                                                                                                 |
| course                      | number  | no       | yes      | Only recorded if the device is moving and has no relation to how the device is oriented; course is in degrees (0.0-360); if no course can be determined then 0.0 will be returned, populated **only** when location has **not** been set manually. |
| horizontal_accuracy         | number  | no       | yes      | Accuracy of the latitude and longitude in meters, populated **only** when location has **not** been set manually.                                                                                                                                  |
| vertical_accuracy           | number  | no       | yes      | Accuracy of the altitude value in meters, populated **only** when location has **not** been set manually.                                                                                                                                          |
