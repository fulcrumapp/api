---
title: Illness Symptoms Selector
author: ''
excerpt: >-
  Launch an illness symptoms selection interface from a Fulcrum form using
  OPENEXTENSION(), then save selected symptom values back to a target text field.
deprecated: false
hidden: false
metadata:
  title: ''
...
[Download clip: OPENEXTENSION Demo for Illness Symptoms Selector.mp4](https://reportassets.fulcrumapp.com/readme-assets/OPENEXTENSION%20Demo%20for%20Illness%20Symptoms%20Selector.mp4)
...
## Setup
1. Download <a href="https://reportassets.fulcrumapp.com/readme-assets/illness-symptoms-selector.html" download="illness-symptoms-selector.html">illness-symptoms-selector.html</a> and upload it as a **Reference File** in your app.
...
## Extension File
The full extension file is available here: [illness-symptoms-selector.html](https://reportassets.fulcrumapp.com/readme-assets/illness-symptoms-selector.html)
