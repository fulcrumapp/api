...
This is the same kind of extension file used in any other App Extension — nothing here is specific to Share PDF. It's included only to give you a complete, working example end to end; you can reuse an extension file you already have without adding anything to it.
