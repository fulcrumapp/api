...
*NOTE*: SETCHOICEFILTER() will filter the top level choice options in a classification set.

*NOTE*: SETCHOICEFILTER() will not filter a choice field if SETCHOICES was previously run on it.
